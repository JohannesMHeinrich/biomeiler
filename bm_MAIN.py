...
#         thread_CO2.start()
    ...
    def update_payloads(self, intervall = 900):
        ...
        while True:
            ...
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_CO2.time_now, 'CO2-temperature', self.c_CO2.temperature))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_CO2.time_now, 'CO2-humidity', self.c_CO2.humidity))
            
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_6147.time_now, 'WS-temperature', self.c_6147.temperature))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_6147.time_now, 'WS-wind_speed', self.c_6147.wind_speed))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_6147.time_now, 'WS-gust_speed', self.c_6147.gust_speed))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_6147.time_now, 'WS-rain', self.c_6147.rain))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_6147.time_now, 'WS-wind_direction', self.c_6147.wind_direction))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_6147.time_now, 'WS-battery_low', self.c_6147.battery_low))
            
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-rel_hum_1', self.c_hum_and_temp.rel_hum_1))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-rel_hum_2', self.c_hum_and_temp.rel_hum_2))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-rel_hum_3', self.c_hum_and_temp.rel_hum_3))

            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_01', self.c_hum_and_temp.temp_01))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_02', self.c_hum_and_temp.temp_02))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_03', self.c_hum_and_temp.temp_03))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_04', self.c_hum_and_temp.temp_04))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_05', self.c_hum_and_temp.temp_05))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_06', self.c_hum_and_temp.temp_06))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_07', self.c_hum_and_temp.temp_07))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_08', self.c_hum_and_temp.temp_08))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_09', self.c_hum_and_temp.temp_09))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_10', self.c_hum_and_temp.temp_10))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_11', self.c_hum_and_temp.temp_11))
            self.mqtt_publish.publish_bm_data_json(self.client, self.get_json_payload(self.c_hum_and_temp.time_now, 'Arduino-temp_12', self.c_hum_and_temp.temp_12))
